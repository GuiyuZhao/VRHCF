...
if __name__ == '__main__':
    ...
    wrong_list=["scene16/pair1", "scene16/pair7", "scene16/pair5", "scene18/pair4", "scene18/pair9", "scene18/pair5",
                "scene10/pair1", "scene13/pair5", "scene14/pair6", "scene15/pair9", "scene19/pair5"]
    for folder in folders:
        ...
        for scene in scenes:
            ...
            pcdpath2 = f"{directory}/{folder}/{scene}/lidar.ply"
